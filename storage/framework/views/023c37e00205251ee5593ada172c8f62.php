  ...
  <div class="slider">
    ...
    <ul class="slides">
      <li class="slide">
        ...
        <p class="slide-image">
          <img src="<?php echo e(asset('img/2.jpg')); ?>" alt="stuff" width="320" height="240">
        </p>
      </li>
      <li class="slide">
        <div class="slide-content">
        ...
        <p class="slide-image">
          <img src="<?php echo e(asset('img/4.jpg')); ?>" alt="stuff" width="320" height="240">
        </p>
      </li>
      <li class="slide">
        <div class="slide-content">
        ...
        <p class="slide-image">
          <img src="<?php echo e(asset('img/5.jpg')); ?>" alt="stuff" width="320" height="240">
        </p>
      </li>
      <li class="slide">
        <div class="slide-content">
          ...
          <a href="<?php echo e(route('student.student.test')); ?>" class="btn btn-primary">Mulai Sekarang!</a>
        </div>
        <p class="slide-image">
          <img src="<?php echo e(asset('img/3.jpg')); ?>" alt="stuff" width="320" height="240">
        </p>
      </li>
    </ul>
  </div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coba\app\resources\views/student/GayaBelajar/instruksi.blade.php ENDPATH**/ ?>