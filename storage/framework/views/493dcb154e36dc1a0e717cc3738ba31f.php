    ...
    <ul class="slides">
      ...
      <li class="slide">
        <div class="slide-content">
          ...
          <a href="<?php echo e(route('student.student.test')); ?>" class="slide-link">Mulai Sekarang!</a>
        </div>
        <p class="slide-image">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/student/GayaBelajar/instruksi.blade.php ENDPATH**/ ?>