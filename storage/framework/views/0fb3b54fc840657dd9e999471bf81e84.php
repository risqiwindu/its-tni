<?php $__env->startSection('pageTitle',$forumTopic->title); ?>
<?php $__env->startSection('innerTitle',__lang('forum-topic')); ?>
...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="ticket-description thread-text">
                            ...
                            <div class="collapse" id="collapseExample<?php echo e($thread->id); ?>">
                                <div class="well">
                                    ...
                                    <form method="post" action="<?php echo e(route('student.forum.reply', ['id' => $id])); ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div style="">
                <input <?php if($checked): ?> checked <?php endif; ?> type="checkbox" name="notify" id="notify"> <label for="notify"><?php echo e(__lang('get-notifications')); ?></label>
    ...
    <script>
        $(function(){
            ...
            $('#notify').change(function(){
                ...
                $.get('<?php echo e(route('student.forum.notifications',['id'=>$id])); ?>?notify='+notify,function(){
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coba\app\resources\views/student/forum/topic.blade.php ENDPATH**/ ?>