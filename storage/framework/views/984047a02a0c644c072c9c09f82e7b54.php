<?php $__env->startSection('pageTitle',__('default.create-new').' '.__('default.role')); ?>
<?php $__env->startSection('innerTitle',__('default.create-new').' '.__('default.role')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coba\app\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>