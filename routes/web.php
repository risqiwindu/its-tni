...
/*    Route::any('setting/roles','SettingController@roles')->name('setting.roles');
    ...
    Route::any('report/laporan/{course_id}','ReportController@laporan')->name('report.laporan');
    ...
    Route::any('report/detail_nilai_akhir/{id}','ReportController@detail_nilai_akhir')->name('report.detail_nilai_akhir');
...
Route::group(['middleware'=>['auth','student'],'prefix' => 'student', 'as' => 'student.','namespace'=>'Student'],function() {
    ...
    Route::any('student/pilihKelas','StudentController@pilihKelas')->name('student.pilihKelas');
...
Route::group(['namespace'=>'Site','middleware'=>'site'],function(){
    ...
    Route::get('/courses','CatalogController@course2')->name('courses');
