...
@section('crumb')
    <li><a href="@route('sessions')">{{ __lang('upcoming-sessions') }}</a></li>
    <li>{{ __lang('session-details') }}</li>
@endsection
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="profile-info">
                                                <h5><a href="javascript:void(0)">{{  $instructor->name.' '.$instructor->last_name  }}</a></h5>
