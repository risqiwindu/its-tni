    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="questionform" method="post" action="{{ adminUrl(['controller'=>'test','action'=>'addquestion','id'=>$id]) }}">
@csrf
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" id="importform" method="post" action="{{ adminUrl(['controller'=>'test','action'=>'importquestions','id'=>$id]) }}">
                @csrf
                    <div class="modal-body">
                        <p>
