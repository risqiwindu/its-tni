...
<div class="form-group">
    ...
    <div class="image-box">
        ...
        <a class="pointer" onclick="image_upload('{{ $imgId }}', '{{ $thumbId }}');">@lang('default.browse')</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="pointer" onclick="$('#{{ $thumbId }}').attr('src', '{{ asset('img/no_image.jpg') }}'); $('#{{ $imgId }}').attr('value', '');">@lang('default.clear')</a>
