...
@section('page-title',$forumTopic->title)
@section('breadcrumb')
...
@section('content')
                    ...
                    <div class="ticket-content">
                        ...
                        <div class="ticket-description thread-text">
                            ...
                            <div class="collapse" id="collapseExample{{$thread->id}}">
                                <div class="well">
                                    <h4>{{ __lang('reply') }}</h4>
                                    <form method="post" action="{{ adminUrl( ['controller' => 'forum', 'action' => 'reply', 'id' => $id]) }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div style="">
                <input @if($checked) checked @endif type="checkbox" name="notify" id="notify" value="1" >  <label for="notify">{{ __lang('get-notifications') }}</label>
    ...
    <script>
        $(function(){
            ...
            $('#notify').change(function(){
                ...
                $.get('{{adminUrl(['controller'=>'forum','action'=>'notifications','id'=>$id]) }}?notify='+notify,function(){
