            ...
            <div class="nav-collapse">
                ...
                @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-border" style="color: black;">
                            <li class="nav-item"><a href="{{ route('student.student.discussion') }}" style="color: black;" class="nav-link">{{ __lang('instructor-chat') }}</a></li>
                            <li class="nav-item"><a href="{{ route('student.forum.index') }}"  style="color: black;" class="nav-link">{{ __lang('student-forum') }}</a></li>
                        </ul>
                    </li>
                    @endif
        ...
        {{-- <nav class="navbar navbar-secondary navbar-expand-lg">
            <div class="container">
                <ul class="navbar-nav">
                    ...
                    @if(setting('menu_show_homework')==1)
                    <li class="nav-item dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-edit"></i><span>Assigment</span></a>
                        <ul class="dropdown-menu dropdown-border">
                    ...
                    @if(setting('menu_show_discussions')==1)
                    <li class="nav-item dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-comments"></i><span>Diskusi</span></a>
                        <ul class="dropdown-menu dropdown-border">
